...
export const getGetPendingApprovalsUrl = (params?: GetPendingApprovalsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/approvals/pending?${stringifiedParams}` : `/api/approvals/pending`
}

/**
 * @summary Get pending approvals (for bot polling)
 */
export const getPendingApprovals = async (params?: GetPendingApprovalsParams, options?: RequestInit): Promise<Approval[]> => {
...
export const getGetPendingApprovalsQueryKey = (params?: GetPendingApprovalsParams,) => {
    return [
    `/api/approvals/pending`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getConfirmApprovalUrl = (id: string,) => {
  ...
  return `/api/approvals/confirm/${id}`
}

/**
 * @summary Mark an approval as processed (bot confirms processing)
 */
export const confirmApproval = async (id: string, options?: RequestInit): Promise<Approval> => {

  return customFetch<Approval>(getConfirmApprovalUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getConfirmApprovalMutationOptions = <TError = ErrorType<void>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ConfirmApprovalMutationError = ErrorType<void>

    /**
 * @summary Mark an approval as processed (bot confirms processing)
 */
export const useConfirmApproval = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof confirmApproval>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
